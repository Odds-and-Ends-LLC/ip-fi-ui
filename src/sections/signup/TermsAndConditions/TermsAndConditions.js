      ...
      <Stack className={styles.termsAndConditions}>
        ...
        <Stack
          ...
          sx={{
            ...
            padding: { mobile: "16px 24px", desktop: "40px 64px" },
          }}
        >
        ...
        <Stack className={styles.termsAndConditionsButtons}>
          <Button variant="outlineGreen" href="/login">
            DECLINE
          </Button>
          <Button variant="solidGreen" onClick={onAcceptTerms}>
            ACCEPT TERMS
          </Button>
        </Stack>
      </Stack>
